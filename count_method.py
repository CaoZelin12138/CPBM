...
def count_method(click, propensity_path, out_path):
    # a, b = 1e-6, 1 - 1e-6
    ...
    predict_prop = np.sum(click, axis=1)
    predict_prop = predict_prop / predict_prop[0]
...
if __name__ == "__main__":
    deminsion = 10
    click_log1_input_path = "../Data/SliceData/w=0.6_relevance=9_author/train_slice_click_log1.txt"
    click_log2_input_path = "../Data/SliceData/w=0.6_relevance=9_author/train_slice_click_log2.txt"
    ...
    context_feature_input_path = "../Data/SliceData/w=0.6_relevance=9_author/train_slice_feature.txt"
    out_path = "../NetWorkResult/w=0.6_relevance=9_author/Count.txt"
    train_propensity_path = "../Data/trainData/w=0.6_relevance=9_author/train_slice_propensity.txt"
    test_propensity_path = "../Data/trainData/w=0.6_relevance=9_author/test_propensity.txt"
    topK_position = 10
    ...
    count_method(click, train_propensity_path, out_path)
